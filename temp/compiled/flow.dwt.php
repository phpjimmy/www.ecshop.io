...
?>
					<div class="col-md-3">
						<div class="image">
                                                    <a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank">
                                                        <img src="<?php echo $this->_var['goods']['goods_thumb']; ?>" border="0" title="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" />
                                                    </a>
						</div>
					</div>
					...
					<div class="col-md-9">
						...
						<div class="caption">
							...
							<div class="info">	
								<ul>      
									<li><?php echo $this->_var['lang']['market_prices']; ?><?php echo $this->_var['goods']['market_price']; ?></li>
									<li><?php echo $this->_var['lang']['shop_prices']; ?><?php echo $this->_var['goods']['goods_price']; ?></li>
                                                                        <li><?php echo $this->_var['lang']['subtotal']; ?><?php echo $this->_var['goods']['goods_price']; ?></li>
								</ul>
							</div>
                                                        
                                                        <?php if ($this->_var['goods']['goods_id'] > 0 && $this->_var['goods']['is_gift'] == 0 && $this->_var['goods']['parent_id'] == 0): ?>
                                                        <label><?php echo $this->_var['lang']['number']; ?>: </label> <input class="bnt_blue_1" type="text" name="goods_number[<?php echo $this->_var['goods']['rec_id']; ?>]" value="<?php echo $this->_var['goods']['goods_number']; ?>" id="goods_number_<?php echo $this->_var['goods']['rec_id']; ?>" size="4" class="inputBg" style="text-align:center " onkeydown="showdiv(this)"/>
                                                        <?php else: ?>
                                                        <?php echo $this->_var['goods']['goods_number']; ?>
                                                        <?php endif; ?>

							<input name="submit" type="submit" class="btn btn-2" value="<?php echo $this->_var['lang']['update_cart']; ?>" />
			...
			<div class="row">
				<div class="col-md-4 col-md-offset-8 ">
					...
					<!--<center><a href="./"><img src="themes/php4/images/continue.gif" alt="continue" /></a></center>-->
				</div>
			</div>
				...
				<div class="pricedetails">
					<div class="col-md-4 col-md-offset-8">
						<table>
							...
							<tr>
								<td>总价</td>
								<td><?php echo $this->_var['shopping_money']; ?></td>
							</tr>
                                                        <tr>
								<td>市场总价</td>
								<td><?php echo $this->_var['market_price']; ?></td>
							</tr>
                                                        <tr>
								<td>优惠</td>
								<td><?php echo $this->_var['saving']; ?> (<?php echo $this->_var['save_rate']; ?>)</td>
							</tr>
							<tr>
								<td>折扣</td>
						                <td><?php echo $this->_var['your_discount']; ?></td>
							</tr>
							...
							<tr style="border-top: 1px solid #333">
								...
								<td><?php echo $this->_var['shopping_money']; ?></td>
                                               ...
                                               <!--<a href="flow.php?step=checkout"><img src="themes/php4/images/checkout.gif" alt="checkout" /></a>-->
    ...
    <h6><span><?php echo $this->_var['lang']['fee_total']; ?></span></h6>
          <?php echo $this->fetch('library/order_total.lbi'); ?>
           <div align="center" style="margin:8px auto;">
            <input type="image" src="themes/php4/images/bnt_subOrder.gif" />
